...
function HowItWorks() {
  const steps = [
    ...
    { id: 2, title: "Get Personalized Guidance", img: "https://img.freepik.com/free-vector/languages-concept-illustration_114360-19548.jpg?semt=ais_hybrid&w=800", desc: "Receive AI-powered business advice, access learning resources, and discover government schemes." },
